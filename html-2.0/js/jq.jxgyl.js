        ...
        $("textarea,input,select").blur(function(){
            ...
            if(e.attr("data-validate")){
                ...
                if($checkstate){
                    ...
                    e.parent().parent().find(".field").html('');
                    e.closest(".form-group").addClass("check-success")
                }else{
                    e.closest(".form-group").removeClass("check-success");
                    e.closest(".form-group").addClass("check-error");
                    e.parent().parent().find(".field").html($checktext);
                }
            }
        });
...
(function($){
    /**
     * @param {any} type   success  info   warning  danger 四个状态
     * @param {any} caret  显示内容
     */
    function alert(type,caret){
        $('body .alert').remove();
